"""
lib/mask_predictor.py  (reverted to clean version)
───────────────────────
return_feat removed — existence head now uses x_c4 directly in _utils.py,
so the decoder doesn't need to expose intermediate features.
"""
